...
inline std::string generate_asm_hard_code()
{
    ...
    array[i++] = 0x240c000c;   // 3c:    240c000c    li    t0,12    
    array[i++] = 0x01cc682f;   // 40:    01cc682f    dsubu    t1,t2,t0    
    array[i++] = 0x67bdff80;   // 44:    67bdff80    daddiu    sp,sp,-128    
    ...
    array[i++] = 0xdfa40030;   // 68:    dfa40030    ld    a0,48(sp)    
    array[i++] = 0x03e0282d;   // 6c:    03e0282d    move    a1,ra    
    array[i++] = 0x67a60080;   // 70:    67a60080    daddiu    a2,sp,128    
    array[i++] = 0xdfad0030;   // 74:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x240c0028;   // 78:    240c0028    li    t0,40    
    array[i++] = 0x01ac682f;   // 7c:    01ac682f    dsubu    t1,t1,t0    
    array[i++] = 0xddac0000;   // 80:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0x0180c82d;   // 84:    0180c82d    move    t9,t0    
    array[i++] = 0x0320f809;   // 88:    0320f809    jalr    t9    
    array[i++] = 0x00000000;   // 8c:    00000000    nop    
    array[i++] = 0x1440000f;   // 90:    1440000f    bnez    v0,d0    <call_hook_handler>    
    array[i++] = 0x00000000;   // 94:    00000000    nop    
    array[i++] = 0xdfad0030;   // 98:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x240c0020;   // 9c:    240c0020    li    t0,32    
    array[i++] = 0x01ac682f;   // a0:    01ac682f    dsubu    t1,t1,t0    
    array[i++] = 0xddac0000;   // a4:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0xdfbf0000;   // a8:    dfbf0000    ld    ra,0(sp)    
    array[i++] = 0xdfa40008;   // ac:    dfa40008    ld    a0,8(sp)    
    array[i++] = 0xdfa50010;   // b0:    dfa50010    ld    a1,16(sp)    
    array[i++] = 0xdfa60018;   // b4:    dfa60018    ld    a2,24(sp)    
    array[i++] = 0xdfa70020;   // b8:    dfa70020    ld    a3,32(sp)    
    array[i++] = 0xdfa80028;   // bc:    dfa80028    ld    a4,40(sp)    
    array[i++] = 0xdfb90038;   // c0:    dfb90038    ld    t9,56(sp)    
    array[i++] = 0x67bd0080;   // c4:    67bd0080    daddiu    sp,sp,128    
    array[i++] = 0x01800008;   // c8:    01800008    jr    t0    
    array[i++] = 0x00000000;   // cc:    00000000    nop    
    array[i++] = 0xdfad0030;   // d0:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x240c0018;   // d4:    240c0018    li    t0,24    
    array[i++] = 0x01ac682f;   // d8:    01ac682f    dsubu    t1,t1,t0    
    array[i++] = 0xddac0000;   // dc:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0x0180c82d;   // e0:    0180c82d    move    t9,t0    
    array[i++] = 0x10000001;   // e4:    10000001    b    ec    <trampoline_exit>    
    array[i++] = 0x00000000;   // e8:    00000000    nop    
    array[i++] = 0xdfbf0000;   // ec:    dfbf0000    ld    ra,0(sp)    
    array[i++] = 0xdfa40008;   // f0:    dfa40008    ld    a0,8(sp)    
    array[i++] = 0xdfa50010;   // f4:    dfa50010    ld    a1,16(sp)    
    array[i++] = 0xdfa60018;   // f8:    dfa60018    ld    a2,24(sp)    
    array[i++] = 0xdfa70020;   // fc:    dfa70020    ld    a3,32(sp)    
    array[i++] = 0xdfa80028;   // 100:    dfa80028    ld    a4,40(sp)    
    array[i++] = 0xdfb90038;   // 104:    dfb90038    ld    t9,56(sp)    
    array[i++] = 0x67bd0080;   // 108:    67bd0080    daddiu    sp,sp,128    
    array[i++] = 0x0180c82d;   // 10c:    0180c82d    move    t9,t0    
    array[i++] = 0x03200008;   // 110:    03200008    jr    t9    
    array[i++] = 0x00000000;   // 114:    00000000    nop    
    array[i++] = 0x12345678;   // 118:    12345678    beq    s1,s4,15afc    <SEGMENT1+0x159e0>    
    array[i++] = 0x64636261;   // 11c:    64636261    daddiu    v1,v1,25185    
    array[i++] = 0x00676665;   // 120:    00676665    0x676665    
    // this is a split comment
