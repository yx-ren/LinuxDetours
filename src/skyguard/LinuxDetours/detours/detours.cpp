...
inline std::string generate_asm_hard_code()
{
    ...
    array[i++] = 0xdfa40030;   // a0:    dfa40030    ld    a0,48(sp)    
    array[i++] = 0x03e0282d;   // a4:    03e0282d    move    a1,ra    
    array[i++] = 0x67a60200;   // a8:    67a60200    daddiu    a2,sp,512    
    array[i++] = 0xdfad0030;   // ac:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x65adffd8;   // b0:    65adffd8    daddiu    t1,t1,-40    
    array[i++] = 0xddac0000;   // b4:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0x0180c82d;   // b8:    0180c82d    move    t9,t0    
    array[i++] = 0x0320f809;   // bc:    0320f809    jalr    t9    
    array[i++] = 0x00000000;   // c0:    00000000    nop    
    array[i++] = 0x1440001b;   // c4:    1440001b    bnez    v0,134    <call_hook_handler>    
    array[i++] = 0x00000000;   // c8:    00000000    nop    
    array[i++] = 0xdfad0030;   // cc:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x65adffe0;   // d0:    65adffe0    daddiu    t1,t1,-32    
    array[i++] = 0xddac0000;   // d4:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0xdfbf0000;   // d8:    dfbf0000    ld    ra,0(sp)    
    array[i++] = 0xdfa40008;   // dc:    dfa40008    ld    a0,8(sp)    
    array[i++] = 0xdfa50010;   // e0:    dfa50010    ld    a1,16(sp)    
    array[i++] = 0xdfa60018;   // e4:    dfa60018    ld    a2,24(sp)    
    array[i++] = 0xdfa70020;   // e8:    dfa70020    ld    a3,32(sp)    
    array[i++] = 0xdfa80028;   // ec:    dfa80028    ld    a4,40(sp)    
    array[i++] = 0xdfb90038;   // f0:    dfb90038    ld    t9,56(sp)    
    array[i++] = 0xdfbd0040;   // f4:    dfbd0040    ld    sp,64(sp)    
    array[i++] = 0xdfb00048;   // f8:    dfb00048    ld    s0,72(sp)    
    array[i++] = 0xdfb10050;   // fc:    dfb10050    ld    s1,80(sp)    
    array[i++] = 0xdfb20058;   // 100:    dfb20058    ld    s2,88(sp)    
    array[i++] = 0xdfb30060;   // 104:    dfb30060    ld    s3,96(sp)    
    array[i++] = 0xdfb40068;   // 108:    dfb40068    ld    s4,104(sp)    
    array[i++] = 0xdfb50070;   // 10c:    dfb50070    ld    s5,112(sp)    
    array[i++] = 0xdfb60078;   // 110:    dfb60078    ld    s6,120(sp)    
    array[i++] = 0xdfb70080;   // 114:    dfb70080    ld    s7,128(sp)    
    array[i++] = 0xdfbe0088;   // 118:    dfbe0088    ld    s8,136(sp)    
    array[i++] = 0xdfa90098;   // 11c:    dfa90098    ld    a5,152(sp)    
    array[i++] = 0xdfaa00a0;   // 120:    dfaa00a0    ld    a6,160(sp)    
    array[i++] = 0xdfab00a8;   // 124:    dfab00a8    ld    a7,168(sp)    
    array[i++] = 0x67bd0200;   // 128:    67bd0200    daddiu    sp,sp,512    
    array[i++] = 0x01800008;   // 12c:    01800008    jr    t0    
    array[i++] = 0x00000000;   // 130:    00000000    nop    
    array[i++] = 0x04110001;   // 134:    04110001    bal    13c    <call_hook_handler+0x8>    
    array[i++] = 0x00000000;   // 138:    00000000    nop    
    array[i++] = 0x03e0702d;   // 13c:    03e0702d    move    t2,ra    
    array[i++] = 0x65df0020;   // 140:    65df0020    daddiu    ra,t2,32    
    array[i++] = 0xdfad0030;   // 144:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x65adffe8;   // 148:    65adffe8    daddiu    t1,t1,-24    
    array[i++] = 0xddac0000;   // 14c:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0x0180c82d;   // 150:    0180c82d    move    t9,t0    
    array[i++] = 0x10000025;   // 154:    10000025    b    1ec    <trampoline_exit>    
    array[i++] = 0x00000000;   // 158:    00000000    nop    
    array[i++] = 0xffa200f0;   // 15c:    ffa200f0    sd    v0,240(sp)    
    array[i++] = 0xffa300f8;   // 160:    ffa300f8    sd    v1,248(sp)    
    array[i++] = 0xdfa40030;   // 164:    dfa40030    ld    a0,48(sp)    
    array[i++] = 0x67a50200;   // 168:    67a50200    daddiu    a1,sp,512    
    array[i++] = 0xdfad0030;   // 16c:    dfad0030    ld    t1,48(sp)    
    array[i++] = 0x65adfff0;   // 170:    65adfff0    daddiu    t1,t1,-16    
    array[i++] = 0xddac0000;   // 174:    ddac0000    ld    t0,0(t1)    
    array[i++] = 0x0180c82d;   // 178:    0180c82d    move    t9,t0    
    array[i++] = 0x0320f809;   // 17c:    0320f809    jalr    t9    
    array[i++] = 0x00000000;   // 180:    00000000    nop    
    array[i++] = 0xdfbf0000;   // 184:    dfbf0000    ld    ra,0(sp)    
    array[i++] = 0xdfa40008;   // 188:    dfa40008    ld    a0,8(sp)    
    array[i++] = 0xdfa50010;   // 18c:    dfa50010    ld    a1,16(sp)    
    array[i++] = 0xdfa60018;   // 190:    dfa60018    ld    a2,24(sp)    
    array[i++] = 0xdfa70020;   // 194:    dfa70020    ld    a3,32(sp)    
    array[i++] = 0xdfa80028;   // 198:    dfa80028    ld    a4,40(sp)    
    array[i++] = 0xdfb90038;   // 19c:    dfb90038    ld    t9,56(sp)    
    array[i++] = 0xdfb00048;   // 1a0:    dfb00048    ld    s0,72(sp)    
    array[i++] = 0xdfb10050;   // 1a4:    dfb10050    ld    s1,80(sp)    
    array[i++] = 0xdfb20058;   // 1a8:    dfb20058    ld    s2,88(sp)    
    array[i++] = 0xdfb30060;   // 1ac:    dfb30060    ld    s3,96(sp)    
    array[i++] = 0xdfb40068;   // 1b0:    dfb40068    ld    s4,104(sp)    
    array[i++] = 0xdfb50070;   // 1b4:    dfb50070    ld    s5,112(sp)    
    array[i++] = 0xdfb60078;   // 1b8:    dfb60078    ld    s6,120(sp)    
    array[i++] = 0xdfb70080;   // 1bc:    dfb70080    ld    s7,128(sp)    
    array[i++] = 0xdfbe0088;   // 1c0:    dfbe0088    ld    s8,136(sp)    
    array[i++] = 0xdfaf0090;   // 1c4:    dfaf0090    ld    t3,144(sp)    
    array[i++] = 0xdfa90098;   // 1c8:    dfa90098    ld    a5,152(sp)    
    array[i++] = 0xdfaa00a0;   // 1cc:    dfaa00a0    ld    a6,160(sp)    
    array[i++] = 0xdfab00a8;   // 1d0:    dfab00a8    ld    a7,168(sp)    
    array[i++] = 0xdfa200f0;   // 1d4:    dfa200f0    ld    v0,240(sp)    
    array[i++] = 0xdfa300f8;   // 1d8:    dfa300f8    ld    v1,248(sp)    
    array[i++] = 0x67bd0200;   // 1dc:    67bd0200    daddiu    sp,sp,512    
    array[i++] = 0xffaf0000;   // 1e0:    ffaf0000    sd    t3,0(sp)    
    array[i++] = 0x03e00008;   // 1e4:    03e00008    jr    ra    
    array[i++] = 0x00000000;   // 1e8:    00000000    nop    
    array[i++] = 0xdfa40008;   // 1ec:    dfa40008    ld    a0,8(sp)    
    array[i++] = 0xdfa50010;   // 1f0:    dfa50010    ld    a1,16(sp)    
    array[i++] = 0xdfa60018;   // 1f4:    dfa60018    ld    a2,24(sp)    
    array[i++] = 0xdfa70020;   // 1f8:    dfa70020    ld    a3,32(sp)    
    array[i++] = 0xdfa80028;   // 1fc:    dfa80028    ld    a4,40(sp)    
    array[i++] = 0xdfb90038;   // 200:    dfb90038    ld    t9,56(sp)    
    array[i++] = 0xdfb00048;   // 204:    dfb00048    ld    s0,72(sp)    
    array[i++] = 0xdfb10050;   // 208:    dfb10050    ld    s1,80(sp)    
    array[i++] = 0xdfb20058;   // 20c:    dfb20058    ld    s2,88(sp)    
    array[i++] = 0xdfb30060;   // 210:    dfb30060    ld    s3,96(sp)    
    array[i++] = 0xdfb40068;   // 214:    dfb40068    ld    s4,104(sp)    
    array[i++] = 0xdfb50070;   // 218:    dfb50070    ld    s5,112(sp)    
    array[i++] = 0xdfb60078;   // 21c:    dfb60078    ld    s6,120(sp)    
    array[i++] = 0xdfb70080;   // 220:    dfb70080    ld    s7,128(sp)    
    array[i++] = 0xdfbe0088;   // 224:    dfbe0088    ld    s8,136(sp)    
    array[i++] = 0xdfa90098;   // 228:    dfa90098    ld    a5,152(sp)    
    array[i++] = 0xdfaa00a0;   // 22c:    dfaa00a0    ld    a6,160(sp)    
    array[i++] = 0xdfab00a8;   // 230:    dfab00a8    ld    a7,168(sp)    
    array[i++] = 0x0180c82d;   // 234:    0180c82d    move    t9,t0    
    array[i++] = 0x03200008;   // 238:    03200008    jr    t9    
    array[i++] = 0x00000000;   // 23c:    00000000    nop    
    array[i++] = 0x12345678;   // 240:    12345678    beq    s1,s4,15c24    <SEGMENT1+0x159e0>    
    array[i++] = 0x64636261;   // 244:    64636261    daddiu    v1,v1,25185    
    array[i++] = 0x00676665;   // 248:    00676665    0x676665    
    array[i++] = 0x00000000;   // 24c:    00000000    nop    
    // this is a split comment
...
PDETOUR_TRAMPOLINE detour_alloc_trampoline(PBYTE pbTarget) // DETOURS_MIPS64
{
    ...
    DETOUR_TRACE(("step 1: found -/+ 256MB(alignment) boundary for address:[%p]\n", pbTarget));
    detour_find_jmp_bounds(pbTarget, &pLo, &pHi);
    ...
    if (pbTry == NULL)
    {
        DETOUR_TRACE(("step 2: try to found region from low address(%p) for target(%p)", pLo, pbTarget));
